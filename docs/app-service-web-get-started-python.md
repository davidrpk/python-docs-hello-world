...
https://github.com/MicrosoftDocs/azure-docs/blob/12ac0c59f2a1c6e42e786bc5f53b01abd55ba990/articles/app-service/app-service-web-get-started-python.md
...
![Sample app running in Azure](docs/media/app-service-web-get-started-python/hello-world-in-browser.png)
...
![Sample app running locally](docs/media/app-service-web-get-started-python/localhost-hello-world-in-browser.png)
...
![Empty web app page](docs/media/app-service-web-get-started-python/app-service-web-service-created.png)
...
![Updated sample app running in Azure](docs/media/app-service-web-get-started-python/hello-azure-in-browser.png)
...
![App Service page in Azure portal](docs/media/app-service-web-get-started-nodejs-poc/nodejs-docs-hello-world-app-service-detail.png)
